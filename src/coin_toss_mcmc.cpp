/**
 * @file   coin_toss_mcmc.cpp
 * @author Dominik Schrempf <dominik.schrempf@gmail.com>
 * @date   Wed Feb 11 15:05:12 2015
 * 
 * @brief  Run a coin toss MCMC simulation.
 *
 * For documentation please refer to the code; it is very well
 * documented.
 * 
 */
...
// User interface.
// Observation.
int n_tosses = 100;             /**< Number of tosses. */
int n_heads  = 58;              /**< Number of observed heads. */
int n_tails  = n_tosses - n_heads; /**< Number of tails. */

// MCMC settings.
int n_iter      = 10000;        /**< Number of iterations to be done. */
int print_every = 500;          /**< Print output every n generations. */
double delta    = 0.1;          /**< Specifies the jump lengths with
